                ...
                try {
                    ...
                    if(response.errorBody()!=null){
                        ...
                        if(error.getError().getEmail()!=null && error.getError().getPassword()!=null){
                            Toast.makeText(MainActivity.this, "Error : "+ error.getError().getEmail().get(0) + " and " + error.getError().getPassword().get(0), Toast.LENGTH_LONG).show();
                        }else if(error.getError().getEmail()!=null){
                            Toast.makeText(MainActivity.this, "Error : "+error.getError().getEmail().get(0), Toast.LENGTH_LONG).show();
                        }else if(error.getError().getPassword()!=null){
                            Toast.makeText(MainActivity.this, "Error : "+error.getError().getPassword().get(0), Toast.LENGTH_LONG).show();
                        }
                    }
                }catch (Exception e){
                    e.printStackTrace();
